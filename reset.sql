-- =========================================
-- OMR STUDIO - RESET TOTAL (Supabase/Postgres)
-- =========================================
...
-- Função utilitária: slug de instância
